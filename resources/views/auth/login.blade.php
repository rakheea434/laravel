...
<section class=" h-full grid justify-center mb-5"> 
    <form class="w-[400px] mt-20" method="POST" action="{{ route('login') }}">
        ...
        <a href="{{route('password.recover')}}">Forget Password?</a>
          <button type="submit" class="rounded-md bg-indigo-600 px-10 py-3 text-2xl font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Login</button>
        </div>
      </form>
</section>
@endsection
